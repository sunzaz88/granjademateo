...
lib.ssMetadata = [
		{name:"PROYECTO GRANJA_atlas_1", frames: [[0,0,1920,1920]]},
		{name:"PROYECTO GRANJA_atlas_2", frames: [[0,0,1600,1600]]},
		{name:"PROYECTO GRANJA_atlas_3", frames: [[0,0,1600,1600]]},
		{name:"PROYECTO GRANJA_atlas_4", frames: [[0,0,1280,1280]]},
		{name:"PROYECTO GRANJA_atlas_5", frames: [[0,982,1857,412],[982,0,860,874],[0,0,980,980]]},
		{name:"PROYECTO GRANJA_atlas_6", frames: [[0,0,954,665],[1398,770,626,617],[0,1437,736,537],[956,0,768,768],[0,667,768,768],[770,770,626,626]]},
		{name:"PROYECTO GRANJA_atlas_7", frames: [[0,0,1780,210],[930,1495,890,105],[0,1495,928,206],[0,825,480,210],[1230,212,480,210],[1230,424,480,210],[602,769,824,361],[0,1132,824,361],[826,1132,824,361],[0,212,600,611],[602,212,626,555]]}
];
...
(lib.CachedBmp_10 = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_7"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_8 = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_5"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._61ZhpVj5NzL_AC_SL1000_ = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_6"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.cartoonhappydonkeyvector = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.play151523_1280 = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.pngwingcom8 = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pngwingcom8pngcopia = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.pngwingcom9 = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_6"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
(lib.pngwingcom9pngcopia2 = function() {
	this.initialize(ss["PROYECTO GRANJA_atlas_6"]);
	this.gotoAndStop(4);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.pngwingcom9pngcopia2();
	this.instance.setTransform(0,0,0.0865,0.0865);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:0.1145,scaleY:0.1145,x:-10,y:-11},0).wait(1).to({scaleX:0.0865,scaleY:0.0865,x:0,y:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-11,87.9,87.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.pngwingcom9();
	this.instance.setTransform(0,0,0.0858,0.0858);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:0.1197,scaleY:0.1197,x:-13,y:-13},0).wait(1).to({scaleX:0.0858,scaleY:0.0858,x:0,y:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-13,-13,91.9,91.9);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.pngwingcom8pngcopia();
	this.instance.setTransform(0,0,0.0387,0.0387);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:0.0512,scaleY:0.0512,x:-10,y:-10},0).wait(1).to({scaleX:0.0387,scaleY:0.0387,x:0,y:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-10,82,82);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.instance = new lib.pngwingcom8();
	this.instance.setTransform(0,0,0.0373,0.0373);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({scaleX:0.0498,scaleY:0.0498,x:-10,y:-10},0).wait(1).to({scaleX:0.0373,scaleY:0.0373,x:0,y:0},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-10,-10,79.7,79.7);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.btnMas2},{t:this.btnMenos2}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.btnMenos.setTransform(324,603,1,1,0,0,0,33,33);
	new cjs.ButtonHelper(this.btnMenos, 0, 1, 2);

	this.btnMas = new lib.btnMas();
	this.btnMas.name = "btnMas";
	this.btnMas.setTransform(260.9,591.9,1,1,0,0,0,29.9,29.9);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.btnMas},{t:this.btnMenos}]}).wait(1));
...
// stage content:
(lib.PROYECTOGRANJA = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/PROYECTO GRANJA_atlas_1.png", id:"PROYECTO GRANJA_atlas_1"},
		{src:"images/PROYECTO GRANJA_atlas_2.png", id:"PROYECTO GRANJA_atlas_2"},
		{src:"images/PROYECTO GRANJA_atlas_3.png", id:"PROYECTO GRANJA_atlas_3"},
		{src:"images/PROYECTO GRANJA_atlas_4.png", id:"PROYECTO GRANJA_atlas_4"},
		{src:"images/PROYECTO GRANJA_atlas_5.png", id:"PROYECTO GRANJA_atlas_5"},
		{src:"images/PROYECTO GRANJA_atlas_6.png", id:"PROYECTO GRANJA_atlas_6"},
		{src:"images/PROYECTO GRANJA_atlas_7.png", id:"PROYECTO GRANJA_atlas_7"},
